 ...
 * represented as object models using the Java types {@link JsonObject}
 * and {@link javax.json.JsonArray}. The interface {@code JsonObject} provides
 ...
 * the class {@link JsonReader}. Similarly, these object models
 * can be written to an output source using the class {@link JsonWriter}.
 *
