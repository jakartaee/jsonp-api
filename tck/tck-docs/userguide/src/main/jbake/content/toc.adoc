...
** link:config.html#GCLHU[4.2 Configuring Your Environment to Repackage and Run the TCK Against the Vendor Implementation]
...
*** link:using.html#GBFVW[5.1.1 To Start JavaTest in Command-Line Mode]
