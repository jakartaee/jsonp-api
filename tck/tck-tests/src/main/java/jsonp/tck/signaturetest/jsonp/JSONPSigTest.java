...
package jsonp.tck.signaturetest.jsonp;

import java.util.Properties;

import jsonp.tck.signaturetest.SigTestEE;
import jsonp.tck.signaturetest.SigTestResult;
...
public class JSONPSigTest extends SigTestEE {
  ...
  public void signatureTest() throws Fault {
    ...
    InputStream inStreamMapfile = JSONPSigTest.class.getClassLoader().getResourceAsStream("jsonp/tck/signaturetest/sig-test.map");
    ...
    InputStream inStreamPackageFile = JSONPSigTest.class.getClassLoader().getResourceAsStream("jsonp/tck/signaturetest/sig-test-pkg-list.txt");
    ...
    InputStream inStreamSigFile = JSONPSigTest.class.getClassLoader().getResourceAsStream("jsonp/tck/signaturetest/jakarta.json.sig_"+packageVersion);
